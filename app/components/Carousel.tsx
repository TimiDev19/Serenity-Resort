...
import executive from '../../assets/pexels-pixabay-235466.jpg'
...
const Carousel = () => {
    ...
    return (
        <div
            ...
            {/* <!--Carousel indicators--> */}
            <div
                className="absolute bottom-0 left-0 right-50 z-[2] mx-[15%] mb-4 flex items-center list-none justify-center p-0"
